...
<p>
Once that’s done, we will now create a role for someone with full access, for this tutorial, we will name it “Supreme Admin”. Then select “Permissions” and make sure all permissions are checked.
</p>
<p>
